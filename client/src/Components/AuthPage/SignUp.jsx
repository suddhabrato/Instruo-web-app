            ...
            <Formik
              ...
              validate={(values) => {
                ...
                if (values.college.trim() === "")
                  errors.college = "Institute name cannot be empty";

                if (values.course.trim() === "")
                  errors.course = "Course name cannot be empty";

                if (!values.graduation_year)
                  errors.graduation_year = "Select your graduation year";
                if (
                  !/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(
                    values.email
                  )
              ...
              onSubmit={async (values, { setSubmitting, resetForm }) => {
                try {
                  ...
                  showToastHandler("Registration failed", "error");
                  console.log(error);
                  resetForm();
                  setSubmitting(false);
                }
