									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Drawer component is useful for
							...
							<div tabindex="0" className="dropdown-content py-2">
								<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
									<div className="card-body">
										...
										<p className="text-neutral-content text-sm text-opacity-80">
											You'll need a navbar on top of your
											page
										</p>{" "}
										<div className="mt-4 flex justify-end">
											<a
								...
								<div
									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Card component is used to show
								...
								<div
									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Use badge component to highlight
												small inline items
											</p>{" "}
											<div className="mt-4 flex justify-end">
												<a
							...
							<div tabindex="0" className="dropdown-content py-2">
								<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
									<div className="card-body">
										...
										<p className="text-neutral-content text-sm text-opacity-80">
											Use it to group multiple buttons
											together
										</p>{" "}
										<div className="mt-4 flex justify-end">
											<a
					...
					<div className="bg-base-100 rounded-box col-span-3 row-span-3 mx-2 flex w-72 flex-shrink-0 flex-col justify-center gap-4 p-4 shadow-xl xl:mx-0 xl:w-full svelte-1n6ue57">
						<div className="px-6 pt-6">
							...
							<div className="text-base-content/70 my-4 text-xs">
								Enable your favorite superpowers. Terms and
								conditions apply
							</div>{" "}
								...
								<div
									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Use toggle to switch between two
												states
											</p>{" "}
											<div className="mt-4 flex justify-end">
												<a
								...
								<div
									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Buttons come in various shapes,
												colors and sizes
											</p>{" "}
											<div className="mt-4 flex justify-end">
												<a
					...
					<div className="card card-compact xl:card-normal bg-base-100 col-span-3 row-span-4 mx-2 w-72 flex-shrink-0 overflow-visible shadow-xl xl:mx-0 xl:w-auto svelte-1n6ue57">
						...
						<div className="card-body">
							...
							<p className="text-base-content text-sm text-opacity-80">
								Use card component to easily show blog posts,
							...
							<div tabindex="0" className="dropdown-content py-2">
								<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
									<div className="card-body">
										...
										<p className="text-neutral-content text-sm text-opacity-80">
											Beautiful tabs to switch between
											sections
										</p>{" "}
										<div className="mt-4 flex justify-end">
											<a
									...
									<div
										...
										<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
											<div className="card-body">
												...
												<p className="text-neutral-content text-sm text-opacity-80">
													Show progressbar, loadings
													or simple bar charts using
													progress component
												</p>{" "}
												<div className="mt-4 flex justify-end">
													<a
							...
							<div tabindex="0">
								<div className="grid gap-4">
									<div className="btn-group flex">
										...
										<button className="btn btn-active flex-1">
											2
										</button>{" "}
										<button className="btn flex-1">
											3
							...
							<div tabindex="0" className="dropdown-content py-2">
								<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
									<div className="card-body">
										...
										<p className="text-neutral-content text-sm text-opacity-80">
											Pagination buttons in many colors
											and sizes!
										</p>{" "}
										<div className="mt-4 flex justify-end">
											<a
						...
						<div className="dropdown dropdown-end dropdown-top">
							<div tabindex="0">
								<div className="tabs tabs-boxed items-center">
									<button className="tab flex-1">
										Tab 1
									</button>{" "}
									<button className="tab tab-active flex-1">
										Tab 2
									</button>{" "}
									<button className="tab flex-1">
										Tab 3
							...
							<div tabindex="0" className="dropdown-content py-2">
								<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
									<div className="card-body">
										...
										<p className="text-neutral-content text-sm text-opacity-80">
											Tab component with several sizes and
											styles
										</p>{" "}
										<div className="mt-4 flex justify-end">
											<a
								...
								<div
									...
									<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
										<div className="card-body">
											...
											<p className="text-neutral-content text-sm text-opacity-80">
												Use it for sidebar or any other
												list of items
											</p>{" "}
											<div className="mt-4 flex justify-end">
												<a
									...
									<div className="dropdown dropdown-top">
										<div tabindex="0">
											<button
												...
												className="btn btn-ghost loading btn-sm btn-circle"></button>
										</div>{" "}
										<div
											tabindex="0"
											className="dropdown-content py-2">
											<div className="card compact bg-neutral-focus text-neutral-content rounded-box w-72 shadow-xl">
												<div className="card-body">
													...
													<p className="text-neutral-content text-sm text-opacity-80">
														Buttons can get loadings
														state using a simple
														className
													</p>{" "}
													<div className="mt-4 flex justify-end">
														<a
