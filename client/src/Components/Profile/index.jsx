...
const Profile = () => {
  ...
  async function getUserDetails() {
    try {
      ...
      showToastHandler("User update failed. Showing older data", "warning");
    }
  }
        ...
        <div className="m-8 my-24 shadow-xl border-2 border-gray-800 p-8 lg:px-16 max-w-screen-xl xl:mx-auto rounded-2xl">
          <div className="flex flex-col-reverse md:flex-row items-center justify-center md:gap-8">
            <div className="px-2">
              ...
              <p className="text-lg mt-4">Phone: {userDetails.mobile}</p>
              <p className="text-lg break-all">Email: {userDetails.email}</p>
            </div>
